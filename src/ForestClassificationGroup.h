...
#ifndef FORESTCLASSIFICATIONGROUP_H_
...
class ForestClassificationGroup: public ForestGroup {
public:
  ForestClassificationGroup() = default;

  ForestClassificationGroup(const ForestClassificationGroup&) = delete;
  ForestClassificationGroup& operator=(const ForestClassificationGroup&) = delete;

  virtual ~ForestClassificationGroup() override = default;

  void loadForest(size_t num_trees, std::vector<std::vector<std::vector<size_t>> >& forest_child_nodeIDs,
      std::vector<std::vector<size_t>>& forest_split_varIDs, std::vector<std::vector<double>>& forest_split_values,
      std::vector<std::vector<std::vector<double>>>& forest_split_coefficients, std::vector<double>& class_values,
...
#endif /* ForestClassificationGroup_H_ */
